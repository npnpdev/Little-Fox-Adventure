...
public class GameManager : MonoBehaviour
{
    ...
    public TMP_Text levelScoreText; // Zmienna dodatkowa przechowuj¹ca wynik "score", w celu wyœwietlenia na ekranie zakonczenia poziomu

    // Tekst ustawieñ grafiki
    ...
    private void Awake()
    {
        ...
        // Ustawienie aktualnego stanu grafiki
    ...
    public void SetGameState(GameState newGameState)
    {
        ...
        {
            return; // Nie zmieniaj stanu, jeœli jest ju¿ ustawiony
        }
    ...
    {
        // Usuwanie fokusu z aktywnego przycisku
    ...
    public void increaseGraphicLevel()
    {
        QualitySettings.IncreaseLevel();
        updateQualityText();
    }

    public void decreaseGraphicLevel()
    {
